...
For the NEW integrated architecture with encoder and patching, see:
    tests/test_multimodal_llm_integrated.py

The MultiModalLLM class has been refactored to integrate:
- GeoEncoder (graph encoder)
...
@pytest.mark.skip(reason="Old API deprecated - see test_multimodal_llm_integrated.py for new tests")
class TestMultiModalLLM:
    """Tests for MultiModalLLM (OLD API - DEPRECATED)."""
    pass

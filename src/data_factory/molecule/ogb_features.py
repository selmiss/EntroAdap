"""
Adopted from the previous version of OGB, to make the feature conversion consistent with MoleculeSTM.
https://github.com/snap-stanford/ogb/blob/1.3.5/ogb/utils/features.py
"""
...
def atom_to_feature_vector(atom):
    ...
    atom_feature = [
            ...
            # This part is modified to include the case where the atom is not chiral
